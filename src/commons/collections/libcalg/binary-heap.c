...
static int
binary_heap_cmp(BinaryHeap *heap, BinaryHeapValue data1, BinaryHeapValue data2)
{
...
BinaryHeap *
binary_heap_new(BinaryHeapType heap_type, BinaryHeapCompareFunc compare_func)
{
    BinaryHeap *heap;
...
int
binary_heap_insert(BinaryHeap *heap, BinaryHeapValue value)
{
...
BinaryHeapValue
binary_heap_pop(BinaryHeap *heap)
{
...
unsigned int
binary_heap_num_entries(BinaryHeap *heap)
{
