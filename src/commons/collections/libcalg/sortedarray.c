...
/* Function for finding first index of range which equals data. An equal value
   must be present. */
static unsigned int
sortedarray_first_index(SortedArray *sortedarray, SortedArrayValue data, unsigned int left,
                        unsigned int right)
{
...
/* Function for finding last index of range which equals data. An equal value
   must be present. */
static unsigned int
sortedarray_last_index(SortedArray *sortedarray, SortedArrayValue data, unsigned int left, unsigned int right)
{
...
SortedArrayValue *
sortedarray_get(SortedArray *array, unsigned int i)
{
...
unsigned int
sortedarray_length(SortedArray *array)
{
    return array->length;
}

SortedArray *
sortedarray_new(unsigned int length, SortedArrayEqualFunc equ_func, SortedArrayCompareFunc cmp_func)
{
...
void
sortedarray_free(SortedArray *sortedarray)
{
    if (sortedarray != NULL) {
...
void
sortedarray_remove(SortedArray *sortedarray, unsigned int index)
{
...
void
sortedarray_remove_range(SortedArray *sortedarray, unsigned int index, unsigned int length)
{
...
int
sortedarray_insert(SortedArray *sortedarray, SortedArrayValue data)
{
...
int
sortedarray_index_of(SortedArray *sortedarray, SortedArrayValue data)
{
    if (sortedarray == NULL) {
        return -1;
    }
...
void
sortedarray_clear(SortedArray *sortedarray)
{
    /* set length to 0 */
    sortedarray->length = 0;
}
