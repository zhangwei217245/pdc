...
static void
trie_free_list_push(TrieNode **list, TrieNode *node)
{
    node->data = *list;
    *list      = node;
}
...
static TrieNode *
trie_free_list_pop(TrieNode **list)
{
    TrieNode *result;
...
static TrieNode *
trie_find_end(Trie *trie, char *key)
{
    TrieNode *node;
    char *    p;
...
static TrieNode *
trie_find_end_binary(Trie *trie, unsigned char *key, int key_length)
{
    TrieNode *node;
    int       j;
    int       c;
...
static void
trie_insert_rollback(Trie *trie, unsigned char *key)
{
    TrieNode *     node;
    TrieNode **    prev_ptr;
    TrieNode *     next_node;
...
int
trie_insert(Trie *trie, char *key, TrieValue value)
{
    TrieNode **rover;
    TrieNode * node;
    char *     p;
...
int
trie_insert_binary(Trie *trie, unsigned char *key, int key_length, TrieValue value)
{
    TrieNode **rover;
    TrieNode * node;
    int        p, c;
...
int
trie_remove_binary(Trie *trie, unsigned char *key, int key_length)
{
    TrieNode * node;
    TrieNode * next;
...
int
trie_remove(Trie *trie, char *key)
{
    TrieNode * node;
    TrieNode * next;
    TrieNode **last_next_ptr;
...
TrieValue
trie_lookup(Trie *trie, char *key)
{
    TrieNode *node;
...
TrieValue
trie_lookup_binary(Trie *trie, unsigned char *key, int key_length)
{
    TrieNode *node;
