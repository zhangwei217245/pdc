...
ArrayList *
arraylist_new(unsigned int length)
{
...
void
arraylist_free(ArrayList *arraylist)
{
...
static int
arraylist_enlarge(ArrayList *arraylist)
{
    ArrayListValue *data;
...
int
arraylist_insert(ArrayList *arraylist, unsigned int index, ArrayListValue data)
{
...
int
arraylist_append(ArrayList *arraylist, ArrayListValue data)
{
    return arraylist_insert(arraylist, arraylist->length, data);
}

int
arraylist_prepend(ArrayList *arraylist, ArrayListValue data)
{
    return arraylist_insert(arraylist, 0, data);
}

void
arraylist_remove_range(ArrayList *arraylist, unsigned int index, unsigned int length)
{
...
void
arraylist_remove(ArrayList *arraylist, unsigned int index)
{
    arraylist_remove_range(arraylist, index, 1);
}

int
arraylist_index_of(ArrayList *arraylist, ArrayListEqualFunc callback, ArrayListValue data)
{
    unsigned int i;
...
void
arraylist_clear(ArrayList *arraylist)
{
...
static void
arraylist_sort_internal(ArrayListValue *list_data, unsigned int list_length,
