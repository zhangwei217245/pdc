...
static int
binomial_heap_cmp(BinomialHeap *heap, BinomialHeapValue data1, BinomialHeapValue data2)
{
...
static void
binomial_tree_ref(BinomialTree *tree)
{
    if (tree != NULL) {
        ++tree->refcount;
    }
...
static void
binomial_tree_unref(BinomialTree *tree)
{
    int i;
...
static BinomialTree *
binomial_tree_merge(BinomialHeap *heap, BinomialTree *tree1, BinomialTree *tree2)
{
...
static void
binomial_heap_merge_undo(BinomialTree **new_roots, unsigned int count)
{
    unsigned int i;
...
static int
binomial_heap_merge(BinomialHeap *heap, BinomialHeap *other)
{
...
BinomialHeap *
binomial_heap_new(BinomialHeapType heap_type, BinomialHeapCompareFunc compare_func)
{
...
void
binomial_heap_free(BinomialHeap *heap)
{
    unsigned int i;
...
int
binomial_heap_insert(BinomialHeap *heap, BinomialHeapValue value)
{
...
BinomialHeapValue
binomial_heap_pop(BinomialHeap *heap)
{
...
unsigned int
binomial_heap_num_entries(BinomialHeap *heap)
{
