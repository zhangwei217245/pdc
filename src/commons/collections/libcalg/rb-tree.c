...
static RBTreeNodeSide
rb_tree_node_side(RBTreeNode *node)
{
...
static RBTreeNode *
rb_tree_node_sibling(RBTreeNode *node)
{
    RBTreeNodeSide side;
...
RBTreeNode *
rb_tree_node_uncle(RBTreeNode *node)
{
...
static void
rb_tree_node_replace(RBTree *tree, RBTreeNode *node1, RBTreeNode *node2)
{
    int side;
...
static RBTreeNode *
rb_tree_rotate(RBTree *tree, RBTreeNode *node, RBTreeNodeSide direction)
{
    RBTreeNode *new_root;
...
RBTree *
rb_tree_new(RBTreeCompareFunc compare_func)
{
    RBTree *new_tree;
...
static void
rb_tree_free_subtree(RBTreeNode *node)
{
    if (node != NULL) {
        /* Recurse to subnodes */
...
static void
rb_tree_insert_case1(RBTree *tree, RBTreeNode *node)
{
    if (node->parent == NULL) {
...
static void
rb_tree_insert_case2(RBTree *tree, RBTreeNode *node)
{
...
static void
rb_tree_insert_case3(RBTree *tree, RBTreeNode *node)
{
...
void
rb_tree_insert_case4(RBTree *tree, RBTreeNode *node)
{
...
void
rb_tree_insert_case5(RBTree *tree, RBTreeNode *node)
{
    RBTreeNode *   parent;
    RBTreeNode *   grandparent;
    RBTreeNodeSide side;
...
RBTreeNode *
rb_tree_insert(RBTree *tree, RBTreeKey key, RBTreeValue value)
{
    RBTreeNode *   node;
    RBTreeNode **  rover;
    RBTreeNode *   parent;
...
RBTreeNode *
rb_tree_lookup_node(RBTree *tree, RBTreeKey key)
{
    RBTreeNode *   node;
    RBTreeNodeSide side;
    int            diff;
...
RBTreeValue
rb_tree_lookup(RBTree *tree, RBTreeKey key)
{
    RBTreeNode *node;
...
void
rb_tree_remove_node(RBTree *tree, RBTreeNode *node)
{
    /* TODO */
}

int
rb_tree_remove(RBTree *tree, RBTreeKey key)
{
    RBTreeNode *node;
...
RBTreeNode *
rb_tree_root_node(RBTree *tree)
{
    return tree->root_node;
}

RBTreeKey
rb_tree_node_key(RBTreeNode *node)
{
    return node->key;
}

RBTreeValue
rb_tree_node_value(RBTreeNode *node)
{
    return node->value;
}

RBTreeNode *
rb_tree_node_child(RBTreeNode *node, RBTreeNodeSide side)
{
...
RBTreeNode *
rb_tree_node_parent(RBTreeNode *node)
{
    return node->parent;
}

RBTreeValue *
rb_tree_to_array(RBTree *tree)
{
    /* TODO */
    return NULL;
}
...
int
rb_tree_num_entries(RBTree *tree)
{
