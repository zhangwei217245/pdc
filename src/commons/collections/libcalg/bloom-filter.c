...
BloomFilter *
bloom_filter_new(unsigned int table_size, BloomFilterHashFunc hash_func, unsigned int num_functions)
{
    BloomFilter *filter;
...
void
bloom_filter_free(BloomFilter *bloomfilter)
{
...
void
bloom_filter_insert(BloomFilter *bloomfilter, BloomFilterValue value)
{
    unsigned int  hash;
...
int
bloom_filter_query(BloomFilter *bloomfilter, BloomFilterValue value)
{
    unsigned int  hash;
    unsigned int  subhash;
    unsigned int  index;
...
void
bloom_filter_read(BloomFilter *bloomfilter, unsigned char *array)
{
...
void
bloom_filter_load(BloomFilter *bloomfilter, unsigned char *array)
{
    unsigned int array_size;
...
BloomFilter *
bloom_filter_union(BloomFilter *filter1, BloomFilter *filter2)
{
    BloomFilter *result;
    unsigned int i;
    unsigned int array_size;
...
BloomFilter *
bloom_filter_intersection(BloomFilter *filter1, BloomFilter *filter2)
{
    BloomFilter *result;
    unsigned int i;
    unsigned int array_size;
