 ...
 * 4.
 */
void indexing_numeric(size_t parallel_index_pos, void *attr_val, int attribute_value_length, char *file_path,
                      char *obj_path, attr_tree_leaf_content_t *leaf_cnt);

void indexing_string(size_t parallel_index_pos, char **attr_val, int attribute_value_length, char *file_path,
                     char *obj_path, attr_tree_leaf_content_t *leaf_cnt);

void convert_index_record_to_in_mem_parameters(index_anchor_t *idx_ancr, miqs_meta_attribute_t *attr,
                                               index_record_t *ir);
